...
public class QuestionListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<QuestionCategories.Section>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, QuestionCategories.ITEMS));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(QuestionCategories.ITEMS.get(position).id);
	}
